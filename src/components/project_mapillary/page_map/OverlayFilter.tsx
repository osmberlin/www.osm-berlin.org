        ...
        <RadioGroupOption
          ...
          className={({ checked }) =>
            twJoin(
              ...
              checked ? 'z-10 border-amber-200 bg-amber-50' : 'border-gray-200',
        ...
        >
          {({ focus, checked }) => (
            <>
              <span
                className={twJoin(
                  checked ? 'border-transparent bg-amber-600' : 'border-gray-300 bg-white',
              ...
              <span className="ml-3 flex flex-col">
                <RadioGroupLabel
                  as="div"
                  className={twJoin(
                    checked ? 'font-medium text-amber-900' : 'font-normal text-gray-900',
                    'text-sm',
                  )}
                >
                  {name}
